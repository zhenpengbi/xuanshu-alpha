...
# 试点基金（代码以 AKShare 权威名称为准，portfolio.json 中文名可能已过期）
PILOT_FUNDS = ["001631", "014880"]
...
def fetch_fund_holdings(code, year="2025"):
...
CIRCLE_OF_COMPETENCE = {
    ...
    # 偏难但可尝试（制造/装备，需更谨慎）
    "borderline": ["机床", "机器人", "传动", "激光", "装备", "控制", "自动化", "电机", "工业"],
    # 超出能力圈（高度技术/半导体/AI算力，普通人难判断长期格局）
    "out": ["半导体", "芯片", "算力", "GPU", "光刻", "存储", "科技", "讯飞", "线程", "诺威"],
}


# 个股代码→能力圈的显式映射(补充关键词法的遗漏)
CODE_CIRCLE = {
    # 食品饮料/消费 - 能力圈内
    "600887": "in",  # 伊利(乳业)
    "000895": "in",  # 双汇(肉制)
